...
print(f"{Fore.GREEN}👋🎉 Welcome to Sentiment Spy! 🕵️{Style.RESET_ALL}")
...
if not user_name:
    ...
    user_name = "Unknown Person"  # If the user didn't type anything, use a default name
...
print(f"\n{Fore.BLACK}Hello, Agent {user_name}!")
